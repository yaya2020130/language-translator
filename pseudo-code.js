...
// find an api that has the following features
    //fined api key 
    // fined the end points for the url
    // fined the search  terms we use for the api 
    // insert this api inside the ajax function 
    // console.log the url and see if it gives the needed data structure
// define all of the global variables
    //  define the inpute parameter for the dictinary
    // define the inpute paramerer used for the translator
// define the div elements,containers,ids and classes used 
// use the jquery to define dom elements
    // var =document.quryselector() 
...
//creat an element so that the out put from the api will be displayed.
        ...
        // make the out put from the program visible on the screen(use the .text method display ) 
        // use the .val method to display the inpute on the screen
        // append the elements created on the container we want to keep
...
// define the sart recording funcion
